...
*/
	...
	$notify.sub('teiParse:calvin', function(fileName,tei,graphics,callback){
		callback(parse(fileName,tei,graphics));
	});

	$notify.sub('teiSave:calvin',function(repository,fileName,level,headerString,structure,toc,abstract,ids,callback){
		$ajax.getJSON({
			url : 'index.php',
			data : {
				module : 'Admin_TEI_calvin',
				action : 'saveSource',
	...
	$notify.sub('teiChangeLevel:calvin',function(id,repository,level,callback){
		$ajax.getJSON({
			url : 'index.php',
			data : {
				module : 'Admin_TEI_calvin',
	...
	$notify.sub('teiChangeNovelty:calvin',function(id,repository,novelty,callback){
		$ajax.getJSON({
			url : 'index.php',
			data : {
				module : 'Admin_TEI_calvin',
