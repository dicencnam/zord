...
(function(undefined) {
	...
	$notify.sub('teiParse:demo', function(fileName,tei,graphics,callback){
		callback(parse(fileName,tei,graphics));
	});

	$notify.sub('teiSave:demo',function(repository,fileName,level,headerString,structure,toc,abstract,ids,callback){
		$ajax.getJSON({
			url : 'index.php',
			data : {
				module : 'Admin_TEI_demo',
				action : 'saveSource',
	...
	$notify.sub('teiChangeLevel:demo',function(id,repository,level,callback){
		$ajax.getJSON({
			url : 'index.php',
			data : {
				module : 'Admin_TEI_demo',
	...
	$notify.sub('teiChangeNovelty:demo',function(id,repository,novelty,callback){
		$ajax.getJSON({
			url : 'index.php',
			data : {
				module : 'Admin_TEI_demo',
