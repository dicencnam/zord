<?php
/**
* Admin_TEI___PORTALDEFAULT__ module - Out JSON
* @package zord
...
*/
class Admin_TEI___PORTALDEFAULT__ extends Module {
	...
	*/
	public function saveSource() {
		...
		$categories = array();
		$file = LIB_FOLDER.'zord'.DS.'__PORTALDEFAULT__'.DS.'categories.json';
		if(file_exists($file))
